...
define('event-seq/tests/helpers/destroy-app', ['exports'], function (exports) {
  'use strict';
...
define('event-seq/tests/helpers/module-for-acceptance', ['exports', 'qunit', 'event-seq/tests/helpers/start-app', 'event-seq/tests/helpers/destroy-app'], function (exports, _qunit, _startApp, _destroyApp) {
  'use strict';
...
define('event-seq/tests/helpers/resolver', ['exports', 'event-seq/resolver', 'event-seq/config/environment'], function (exports, _resolver, _environment) {
  'use strict';
...
define('event-seq/tests/helpers/start-app', ['exports', 'event-seq/app', 'event-seq/config/environment'], function (exports, _app, _environment) {
  'use strict';
...
define('event-seq/tests/integration/components/advanced-case-demo-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | advanced-case-demo', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "rCjjnNOX",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"advanced-case-demo\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "5bu87sNv",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"advanced-case-demo\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('event-seq/tests/integration/components/basic-case-demo-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | basic-case-demo', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "q4sbKEKU",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"basic-case-demo\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "2OmH9b/+",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"basic-case-demo\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('event-seq/tests/integration/components/result-display-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | result-display', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "KPBjXLMH",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"result-display\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "B9car7C2",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"result-display\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('event-seq/tests/integration/components/square-box-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | square-box', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "Y9bGhgUI",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"square-box\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "LBSxmZ8p",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"square-box\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('event-seq/tests/lint/app.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('components/advanced-case-demo.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/advanced-case-demo.js should pass ESLint\n\n');
  });

  QUnit.test('components/basic-case-demo.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/basic-case-demo.js should pass ESLint\n\n');
  });

  QUnit.test('components/result-display.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/result-display.js should pass ESLint\n\n');
  });

  QUnit.test('components/side-menu.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/side-menu.js should pass ESLint\n\n');
  });

  QUnit.test('components/square-box.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/square-box.js should pass ESLint\n\n');
  });

  QUnit.test('controllers/expert-case.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/expert-case.js should pass ESLint\n\n');
  });

  QUnit.test('initializers/redux.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'initializers/redux.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('routes/advanced-case.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/advanced-case.js should pass ESLint\n\n');
  });

  QUnit.test('routes/basic-case.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/basic-case.js should pass ESLint\n\n');
  });

  QUnit.test('routes/expert-case.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/expert-case.js should pass ESLint\n\n');
  });

  QUnit.test('state/configure-store.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'state/configure-store.js should pass ESLint\n\n');
  });

  QUnit.test('state/duck.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'state/duck.js should pass ESLint\n\n');
  });
});
define('event-seq/tests/lint/tests.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('integration/components/advanced-case-demo-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/advanced-case-demo-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/basic-case-demo-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/basic-case-demo-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/result-display-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/result-display-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/square-box-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/square-box-test.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('unit/controllers/expert-case-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/expert-case-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/advanced-case-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/advanced-case-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/basic-case-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/basic-case-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/expert-case-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/expert-case-test.js should pass ESLint\n\n');
  });
});
...
define('event-seq/tests/test-helper', ['event-seq/app', 'event-seq/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
define('event-seq/tests/unit/controllers/application-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('event-seq/tests/unit/controllers/expert-case-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Controller | expert-case', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    // Replace this with your real tests.
    (0, _qunit.test)('it exists', function (assert) {
      let controller = this.owner.lookup('controller:expert-case');
      assert.ok(controller);
    });
  });
});
define('event-seq/tests/unit/routes/advanced-case-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | advanced-case', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    (0, _qunit.test)('it exists', function (assert) {
      let route = this.owner.lookup('route:advanced-case');
      assert.ok(route);
    });
  });
});
define('event-seq/tests/unit/routes/basic-case-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | basic-case', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    (0, _qunit.test)('it exists', function (assert) {
      let route = this.owner.lookup('route:basic-case');
      assert.ok(route);
    });
  });
});
define('event-seq/tests/unit/routes/expert-case-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | expert-case', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
require('event-seq/tests/test-helper');
